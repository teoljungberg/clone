if testcase "clone inside project base directory"; then
  ...
  assert_eq \
    "git@github.com:another-user/project $HOME/src//github.com/another-user/project" \
    "$(clone "another-user/project")"
  assert_eq \
    "git@github.com:another-user/project $HOME/src//github.com/another-user/project" \
    "$(clone "another-user/project.git")"
  assert_eq \
    "git@github.com:teoljungberg/project $HOME/src//github.com/teoljungberg/project" \
    "$(clone "project")"
  assert_eq \
    "git@github.com:teoljungberg/project $HOME/src//github.com/teoljungberg/project" \
    "$(clone "project.git")"
